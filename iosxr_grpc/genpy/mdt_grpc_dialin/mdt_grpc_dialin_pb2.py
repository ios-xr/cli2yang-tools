...
ConfigGetArgs = _reflection.GeneratedProtocolMessageType('ConfigGetArgs', (_message.Message,), dict(
  ...
  __module__ = 'mdt_grpc_dialin.mdt_grpc_dialin_pb2'
